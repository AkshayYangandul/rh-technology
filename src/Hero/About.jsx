...
const About = () => {
    ...
    return (
        <section className="py-12 sm:py-16 md:py-20 lg:py-30 px-4 sm:px-6 md:px-12 lg:px-45 bg-white relative overflow-visible">

            {/* ================= LEFT + RIGHT GRID ================= */}
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 md:gap-16 lg:gap-20 items-start">
                ...
                >
                    ...
                    <motion.button
                        ...
                        className="text-xs sm:text-sm md:text-base text-white bg-[#ff5b3b] hover:bg-[#f9360e] px-4 sm:px-6 md:px-8 lg:px-10 py-2.5 sm:py-3 md:py-4 rounded-md shadow-xl flex items-center gap-2 sm:gap-3 cursor-pointer w-auto sm:w-auto"
                    >
                        <span className="text-center font-semibold sm:text-left">Check details about our company</span>
                    </motion.button>
                </motion.div>
